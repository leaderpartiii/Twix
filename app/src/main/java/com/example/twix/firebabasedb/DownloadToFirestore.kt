...
private fun getHashMapPost(posts: MutableList<Post>): HashMap<String, Any> {
    return hashMapOf(
...
private fun getHashMapPerson(person: PersonEntity): HashMap<String, Any> {
    return hashMapOf(
        "nick" to person.nick,
...
fun savePerson(person: PersonEntity) {
    ...
    val personMap = getHashMapPerson(person)
...
fun updatePerson(person: PersonEntity) {
    ...
    val postMap = getHashMapPerson(person)
...
fun updatePersonPosts(nickname: String, posts: MutableList<Post>) {
    ...
    val personMap = getHashMapPost(posts)
